...
![Big-O Complexity Chart](https://cdn-images-1.medium.com/max/1000/1*5ZLci3SuR0zM_QlZOADv8Q.jpeg)

## Data Structure Basics

![Common Data Structure operations](https://cdn-images-1.medium.com/max/1400/1*Uzrw9faXdYgg20I6NjUTBw.png)
...
Above figure shows a Singly linked list.
...
![Circularly linked list](https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Circularly-linked-list.svg/350px-Circularly-linked-list.svg.png)
...
**Stack** is commonly implemented with linked lists but can be made from arrays too.
* Stacks are **last in, first out** (LIFO) data structures.
* They are made with a linked list by having the head be the only place for insertion and removal.
...
### **Binary Tree**
![Binary Tree](https://i.imgur.com/jtKkzAD.png)
...
![Array Sorting Algorithms](https://cdn-images-1.medium.com/max/800/1*X1hZCxNdfgZ0sT_2tynPKA.png)
...
### **Merge Sort**
![Merge Sort](https://i.stack.imgur.com/YlHqG.gif)
#### Definition:
